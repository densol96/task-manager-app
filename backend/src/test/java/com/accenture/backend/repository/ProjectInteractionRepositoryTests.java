...
public class ProjectInteractionRepositoryTests {
    ...
    void setUp() {
        user = userRepo.save(User.builder()
                ...
                .role(Role.USER)
                .build());
        project = projectRepo.save(Project.builder().title("Test project").description("Test description").build());
    ...
    public void findAllByProjectIdAndTypeAndStatus_ReturnsPendingApplication() {
        List<ProjectInteraction> results = interactionRepo.findAllByProjectIdAndTypeAndStatus(
                project.getId(), ProjectInteraction.Type.APPLICATION, ProjectInteraction.Status.PENDING);
    ...
    public void findAllByUserIdAndTypeAndStatus_ReturnsOnlyInteractionsForSpecificUser() {
        Project project2 = projectRepo
                .save(Project.builder().title("Another project").description("Another description").build());
